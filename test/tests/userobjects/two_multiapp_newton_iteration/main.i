# Main-app for TwoMultiAppNewtonIterationUserObject test.
#
...
[UserObjects]
  [newton_uo]
    type = TwoMultiAppNewtonIterationUserObject
    sub_app_input = sub.i
...
[Outputs]
  # Sub-app CSVs (app1_out.csv, app2_out.csv) show output_pp = u(t).
  # Expected values: output_pp = 1, 4, 9 at t = 1, 2, 3.
  csv = true
[]
