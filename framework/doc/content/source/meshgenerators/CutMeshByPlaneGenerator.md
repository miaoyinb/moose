...
As all the non-`TET4` elements are converted into `TET4` elements, the output mesh only contains `TET4` elements. Thus, all the subdomain ids and names of the input mesh are preserved in the output mesh.
