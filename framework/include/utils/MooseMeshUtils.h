 ...
 * @param points The original list of points to be offset. If empty, this vector will be generated
 * based on the input 1D polyline mesh
 * @param mid_points The list of midpoints corresponding to the points for quadratic elements. If
 * both this and the points vector are empty, they will be generated based on the input 1D polyline
 * mesh.
...
/**
 * Collects key points from a meshed hole.
 * @param bdry_mh The meshed hole from which to collect key points
 * @param points The vector to store the collected points
 * @param mid_points The vector to store the collected midpoints
 * @param skip_node_reduction Whether to skip node reduction

 */
void collectKeyPointsFromMesh(TriangulatorInterface::MeshedHole & bdry_mh,
                              std::vector<Point> & points,
                              std::vector<Point> & mid_points,
