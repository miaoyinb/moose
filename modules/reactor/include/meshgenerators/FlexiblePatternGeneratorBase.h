...
/**
 * This FlexiblePatternGeneratorBase object is the base class of
 */
class FlexiblePatternGeneratorBase : public PolygonMeshGeneratorBase
{
public:
  static InputParameters validParams();

  FlexiblePatternGeneratorBase(const InputParameters & parameters);
