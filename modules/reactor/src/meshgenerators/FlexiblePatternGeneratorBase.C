...
InputParameters
FlexiblePatternGeneratorBase::validParams()
{
  ...
  params.addClassDescription("This FlexiblePatternGeneratorBase is the base class of.");
...
FlexiblePatternGeneratorBase::FlexiblePatternGeneratorBase(const InputParameters & parameters)
...
FlexiblePatternGeneratorBase::generate()
{
