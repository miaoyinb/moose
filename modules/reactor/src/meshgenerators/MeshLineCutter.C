...
void
MeshLineCutter::lineRemover(ReplicatedMesh & mesh,
...
bool
MeshLineCutter::lineSideDeterminator(const Real px,
                                     const Real py,
                                     const Real param_1,
                                     const Real param_2,
                                     const Real param_3,
...
Point
MeshLineCutter::twoLineIntersection(const Real param_11,
                                    const Real param_12,
                                    const Real param_13,
                                    const Real param_21,
                                    const Real param_22,
...
bool
MeshLineCutter::quasiTriElementsFixer(ReplicatedMesh & mesh,
                                      const std::set<subdomain_id_type> subdomain_ids_set,
                                      const std::string tri_elem_subdomain_name_suffix,
...
MeshLineCutter::vertex_angles(Elem & elem) const
{
